package io.dereknelson.lostcities.accounts.library.cache
...
class PrefixedKeyGenerator(gitProperties: GitProperties?, buildProperties: BuildProperties?) :
    KeyGenerator {
...
private class PrefixedSimpleKey(prefix: String, methodName: String, vararg elements: Any?) :
    Serializable {
    ...
    override fun equals(other: Any?): Boolean {
        return this === other ||
            other is PrefixedSimpleKey && prefix == other.prefix &&
            methodName == other.methodName && Arrays.deepEquals(params, other.params)
    }
